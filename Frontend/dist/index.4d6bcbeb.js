...
var _databaseinteractionsJs = require("./modules/databaseinteractions.js");
let playerName;
let playerScore = 0;
// variables to keep track of the points
let pointsPlayer = 0;
let pointsComputer = 0;
/* select buttons from html by id */ const rockBtn = document.querySelector("#rock");
const paperBtn = document.querySelector("#paper");
const scissorsBtn = document.querySelector("#scissors");
async function updateHighscoreTable() {
    await (0, _databaseinteractionsJs.getHighscoreList)().then((highscores)=>{
...
/* select the containers for the choosen img */ const imgContainerPl1 = document.querySelector("#pick-1");
const imgContainerPl2 = document.querySelector("#pick-2");
/* input fields for adding a name */ const textInput = document.querySelector("#player-one-input");
...
async function saveName(event) {
    ...
    textInputC.value = "";
    const highscoreList = await (0, _databaseinteractionsJs.getHighscoreList)();
    (0, _databaseinteractionsJs.addNewPlayer)({
        name: playerName,
        score: playerScore
    });
}
...
/* select all btn from player container */ const choiceBtn = document.querySelectorAll("#image-container-pl-1 button"); // i set this to the div which holds the buttons for player 1 so only the buttons in this div will be clickable
// it will only loop the buttons of the player not computer
/* select the play btn and addEventListener */ const playBtn = document.querySelector("#play");
const numToStart = document.querySelector("#countStart");
playBtn.addEventListener("click", startCountDown);
/* set timing events  */ let countDownInterval;
...
function startCountDown() {
    ...
    countDownInterval = setInterval(()=>{
        numCountReverce--;
        if (numCountReverce > 0) numToStart.innerText = numCountReverce;
        else {
...
for(let i = 0; i < choiceBtn.length; i++){
    ...
    button.addEventListener("click", function(event) {
        ...
        let playerChoice;
        /* set the btnId to playerChoice */ if (btnId === "rock") playerChoice = "rock";
        else if (btnId === "paper") playerChoice = "paper";
        else if (btnId === "scissors") playerChoice = "scissors";
...
function playGame(playerChoice) {
    ...
    if (playerChoice === "rock") {
        const imgRock = new URL(require("62f8234b3f3ff5cd"));
        createAndDisplayImage(imgRock.href, "pick-1");
    } else if (playerChoice === "paper") {
        const imgPaper = new URL(require("5344f4da681c0a56"));
        createAndDisplayImage(imgPaper.href, "pick-1");
    } else if (playerChoice === "scissors") {
        const imgScissors = new URL(require("3b17f0172018e337"));
    ...
    playBtn.innerText = "Play again";
    let winner;
    if (playerChoice === computerChoice) winner = "No winner, try again!";
        ...
        const updatedPlayer = {
            name: playerName,
            score: parseInt(pointsPlayer, 10)
        };
        (0, _databaseinteractionsJs.addNewPlayer)(updatedPlayer);
...
},{"./modules/databaseinteractions.js":"84vVW","62f8234b3f3ff5cd":"lFwAt","5344f4da681c0a56":"9dkEm","3b17f0172018e337":"cZija"}],"84vVW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getHighscoreList", ()=>getHighscoreList);
parcelHelpers.export(exports, "addNewPlayer", ()=>addNewPlayer);
...
},{}],"lFwAt":[function(require,module,exports) {
module.exports = require("98ecd04565f586c3").getBundleURL("gnRNX") + "rock.71315902.png" + "?" + Date.now();

},{"98ecd04565f586c3":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"9dkEm":[function(require,module,exports) {
module.exports = require("3dc9a9d656d6cf52").getBundleURL("gnRNX") + "paper.b97b1903.png" + "?" + Date.now();

},{"3dc9a9d656d6cf52":"lgJ39"}],"cZija":[function(require,module,exports) {
module.exports = require("fd4eb5f79ff43dae").getBundleURL("gnRNX") + "scissors.6e251f7c.png" + "?" + Date.now();

},{"fd4eb5f79ff43dae":"lgJ39"}]},["3zq8u","gLLPy"], "gLLPy", "parcelRequireb085")
